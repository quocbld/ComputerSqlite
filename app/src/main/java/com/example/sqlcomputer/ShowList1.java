 ...
 *
 */
public class ShowList1 extends Activity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        // TODO Auto-generated method stub
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_list1);
        updateUI();
    ...
    public void updateUI()
    {
        ...
        if(database!=null)
        {
            ...
            header.setField2("Mã Category");
            header.setField3("Tên Category");
            list.add(header);
            cursor.moveToFirst();
            ...
            cursor.close();
            adapter=new ComputerAdapter(ShowList1.this, R.layout.mylayout_show_listdata, list);
            ...
            lv.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                                        int arg2, long arg3) {
                    // TODO Auto-generated method stub
                    Toast.makeText(ShowList1.this,"View -->"+ list.get(arg2).toString(), Toast.LENGTH_LONG).show();
                    Intent intent=new Intent(ShowList1.this, CreateCategoryActivity.class);
            ...
            lv.setOnItemLongClickListener(new OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                    ...
                    final int pos=arg2;
                    Toast.makeText(ShowList1.this, "Edit-->"+data.toString(), Toast.LENGTH_LONG).show();
                    AlertDialog.Builder b=new Builder(ShowList1.this);
                    b.setTitle("Remove");
                    ...
                    b.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(n>0)
                            {
                                Toast.makeText(ShowList1.this, "Remove ok", Toast.LENGTH_LONG).show();
                                list.remove(pos);
                                adapter.notifyDataSetChanged();
                            }
                            else
                            {
                                Toast.makeText(ShowList1.this, "Remove not ok", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode==MainActivity.SEND_DATA_FROM_CATEGORY_ACTIVITY)
        {
            ...
            if(database!=null)
            {
                ...
                if(n>0)
                {
                    Toast.makeText(ShowList1.this, "update ok ok ok ", Toast.LENGTH_LONG).show();
