...
public class InsertComputerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new ComputerAdapter(InsertComputerActivity.this, R.layout.mylayout_show_listdata,listAuthor);
    ...
    public void loadAllListBook()
    {
        ...
        cur.close();
        adapter=new ComputerAdapter(InsertComputerActivity.this, R.layout.mylayout_show_listdata, listBook);
